---
title: "Using External Components in ESPHome"
sidebarTitle: "External Components"
description: "Load community and custom ESPHome components from GitHub or local directories using the external_components configuration block."
---
