---
title: "ESPHome Native API: Protobuf TCP Protocol"
...
<ParamField path="max_connections" type="integer">
  Maximum simultaneous client connections. Defaults to 4 (ESP8266/RP2040) or 5 (ESP32). Each connection uses approximately 500–1000 bytes of RAM.
</ParamField>
