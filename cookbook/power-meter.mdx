...
description: "Monitor whole-home electricity usage with ESPHome by counting utility-meter LED pulses with a photoresistor or S0 port to report live watts and daily kWh."
---
...
<Steps>
  ...
  <Step title="Reset the kWh total">
    ...
    `pulse_meter` tracks internally; multiply your kWh reading by the impulse constant to convert).
  </Step>
</Steps>
...
- [Home Assistant Time Source](https://esphome.io/components/time/homeassistant/)
