...
- [Substitutions Component Reference](/guides/packages-substitutions)
- [Packages Component Reference](/guides/packages-substitutions)
- [YAML `!include` Reference](/guides/yaml-configuration)
