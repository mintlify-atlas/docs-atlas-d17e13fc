...
|---|---|---|
| **Python** | 3.9+ | 3.11 or newer recommended |
...
<Note>
  ESPHome requires Python 3.9 or newer. Check your version with `python3 --version` before installing. Python 3.11 or later is recommended for the best performance and compatibility.
</Note>
