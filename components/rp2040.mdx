---
title: "RP2040 (Raspberry Pi Pico) Platform in ESPHome"
sidebarTitle: "RP2040"
description: "Use ESPHome on RP2040 microcontrollers (Raspberry Pi Pico, Pico W). Covers board config, flash mode, and supported components."
---
