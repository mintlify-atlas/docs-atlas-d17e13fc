---
title: "ESPHome Core Configuration: name, area, and Build Options"
sidebarTitle: "Core (esphome:)"
description: "Configure the ESPHome core block: device name, friendly_name, area, build options, includes, libraries, and project metadata for every node."
---
