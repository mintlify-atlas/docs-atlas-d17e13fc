---
title: "MQTT Component: Broker Config and Discovery in ESPHome"
sidebarTitle: "MQTT"
...
<ParamField path="use_abbreviations" type="boolean">
  Whether to use [abbreviations](https://www.home-assistant.io/docs/mqtt/discovery/) in MQTT discovery messages. Shorter keys reduce payload size. Defaults to `true`.
</ParamField>
